...
public:
	Single();
	Single(Bank* input_primary_bank, string input_serial_number, int input_lanuage_available, int* initial_fund[], int* fees[4], vector<Bank*>& bank_list, vector<ATM*>& ATM_list);
	~Single();
